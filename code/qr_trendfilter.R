...
system.time(model4 <- quantreg_trendfilter(y, q=q, k=2L, lambda=1000, method = "prox",
                                           penalty = "l1", pen.par = NULL,
                                           objtol = 1e-6, max.iter = 1e4))
system.time(model5 <- quantreg_trendfilter(y, q=q, k=2L, lambda=1000, method = "prox",
                                           penalty = "double-pareto", pen.par = NULL,
                                           objtol = 1e-6, max.iter = 1e4))
