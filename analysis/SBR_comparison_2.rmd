...
boxplot(res[, c(2, 4, 6, 9, 8, 7)], names = method.names, las = 2, ylab = "Run Time", main = "Comparison on Run Time in Seconds (n = 120, p = 100)", ylim = c(0, 15))
```
...
par(mar = c(6.1, 2.5, 2.1, 1.1))
method.names = c("OLS", "LASSO", "Elastic Net", "Bayesian Bridge", "Spike & Slab", "SBR")
boxplot(res[, c(2, 4, 6, 9, 8, 7)], names = method.names, las = 2, ylab = "Run Time", main = "Comparison on Run Time in Seconds (n = 300, p = 200)", ylim = c(0, 80))
```
