...
$$
\phi(u) = \frac{1}{2\sigma^2}u^2 + \frac{z^*(\sigma^2 + s^2)}{2\sigma^2s^2}\|u\|_0
$$
where $\|u\|_0 = I(u \neq 0)$ is the indicator of $u$ being nonzero, $z^*$ defined as above.  Written in another way

$$
\begin{array}{rl}
& \arg\min_u\{\frac1{2s^2}(z - u)^2 + \phi(u)\}\\
= & \arg\min_u\{\frac1{2s^2}(z - u)^2 + \frac{1}{2\sigma^2}u^2 + \frac{z^*(\sigma^2 + s^2)}{2\sigma^2s^2}\|u\|_0\}\\
= &
\begin{cases}
0 & |z| \leq z_{s, \pi, \sigma}^* \\
\frac{z\sigma^2}{\sigma^2 + s^2} & \text{otherwise}
